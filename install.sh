...
#Update Emulators.cfg
wget -O- https://raw.githubusercontent.com/julenvitoria/FreeplayGBAcm3-Emulators.cfg/master/emulators.cfg>/home/pi/RetroPie/retropiemenu/Update-Addons/UpdateEmulators.sh
