...
sleep 2
wget -O- https://raw.githubusercontent.com/julenvitoria/FreeplayGBA/master/ESoriginalgamelist/gamelist.xml>/opt/retropie/configs/all/emulationstation/gamelists/retropie/gamelist.xml
